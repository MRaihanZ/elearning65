        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 my-auto">
                    <p class="fs-1 fw-bold mb-5">E-Learning SMKN 65 Jakarta</p>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum illo minima optio rem in obcaecati
                        accusantium
                        aliquid ab nemo commodi harum, ipsam nostrum maiores. Facilis explicabo culpa dicta. Ipsum nisi
                        veritatis
                        nobis
                        et doloremque est ad commodi ullam quo provident amet, eum ipsam aliquam voluptas perspiciatis
                        eveniet
                        architecto modi vel, tenetur aliquid laudantium sed rerum? Dolores esse velit quidem, dolor possimus
                        dolorum
                        nostrum? Dignissimos id quam obcaecati eos deleniti minus aliquid cumque ab. Neque illo beatae quam
                        laudantium
                        veniam nostrum obcaecati modi quasi at iste ducimus harum ea blanditiis animi quibusdam, vel
                        accusamus,
                        eos
                        dolorum voluptas necessitatibus unde? Asperiores, consequatur.</p>
                </div>
                <div class="col-md-5 offset-md-1 p-2 about_svg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="851.034" height="557.34684" viewBox="0 0 851.034 557.34684"
                        ...
                        <path
                            ...
                            fill="#3f3d56" />
                        <rect id="uuid-dac6dc9f-03bc-4283-a90c-97bcdcbf45dc" y="550.55711" width="851.034" height="1.683"
                            fill="#e6e6e6" />
                        <rect id="uuid-2f9646f7-bb94-4523-8d2e-fd8f0877664c" y="464.55711" width="851.034" height="1.683"
                            fill="#e6e6e6" />
                        <g>
                            ...
                            <polygon
                                ...
                                fill="#2f2e41" />
                            <circle cx="345.47862" cy="89.61301" r="18.93821" fill="#ffb6b6" />
                            <path
                        ...
                        <g>
                            <g>
                                ...
                                <path
                                    ...
                                    fill="#e6e6e6" />
                                <ellipse cx="202.71703" cy="359.19888" rx="14.31298" ry="8.84037"
                                    transform="translate(-194.61752 248.54951) rotate(-45)" fill="#ffb6b6" />
                            </g>
                            <g>
                                <polygon
                            ...
                            <path
                                ...
                                fill="#e6e6e6" />
                            <circle cx="133.73351" cy="287.78009" r="21.54104" fill="#ffb6b6" />
                            <path
                                ...
                                fill="#2f2e41" />
                            <rect x="60.3339" y="393" width="8" height="158" fill="#3f3d56" />
                            <rect x="254.3339" y="393" width="8" height="158" fill="#3f3d56" />
                            <rect x="158.3339" y="326" width="53" height="53" fill="#6c63ff" />
                            <g>
                                <polygon
                                ...
                                <path
                                    ...
                                    fill="#e6e6e6" />
                                <ellipse cx="158.93615" cy="366.77634" rx="14.31298" ry="8.84037"
                                    transform="translate(-212.79872 219.81113) rotate(-45)" fill="#ffb6b6" />
                            </g>
                            <rect x="36.3339" y="387" width="242" height="18" fill="#3f3d56" />
                        </g>
                        <rect x="483.3339" y="243" width="46" height="25" rx="5.12992"
                            ry="5.12992" fill="#3f3d56" />
                        <rect x="558.3339" y="257.74015" width="46" height="10.25985" rx="5.12992"
                            ry="5.12992" fill="#6c63ff" />
                    </svg>
                </div>
            </div>
        </div>
    </section>
    <section class="developer mb-5">
        <div class="container">
            <div class="row">
                <p class="fs-1 fw-bolder">Developer</p>
                <figure class="c_card col-md-4">
                    <img src="assets/img/profile/raihan-transformed.jpeg" class="card-img-top" alt="Developer 1">
                    <figcaption><a href="#" class="btn btn-primary">Muhammad Raihan Zhafran</a></figcaption>
                </figure>
                <figure class="c_card col-md-4">
                    <img src="assets/img/profile/Untitled.png" class="card-img-top" alt="Developer 2">
                    <figcaption><a href="#" class="btn btn-primary">Igun</a></figcaption>
                </figure>
                <figure class="c_card col-md-4">
                    <img src="assets/img/profile/temp.png" class="card-img-top" alt="Developer 3">
                    <figcaption>
                        <a href="#" class="btn btn-primary">Toper</a>
                    </figcaption>
                </figure>
            </div>
        </div>
    </section>
    <section class="d-flex justify-content-center pb-5 map">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5609.141028366798!2d106.87860545879767!3d-6.229194079005017!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f325cc3523e1%3A0x5e6945075e20de57!2sSMK%20Negeri%2065%20Jakarta!5e0!3m2!1sen!2sid!4v1687279564408!5m2!1sen!2sid"
